...
public class StoreSteps {
    ...
    public ValidatableResponse createStore(  String name, String type, String address, String address2,
                                           String city, String state, String zip, int lat, int lng, String hours) {
    ...
    public ValidatableResponse updateStore(int storeId, String name, String type, String address,
                                           String address2, String city, String state, String zip, int lat, int lng, String hours) {
    ...
    public ValidatableResponse deleteStore(int storeId) {
        ...
        return SerenityRest.given().log().all()
                .pathParam("storeID", storeId)
                .when()
                .get(EndPoint.DELETE_STORE_BY_ID)
                .then();
    }
